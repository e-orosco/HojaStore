...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference("Seller.count") do
      post sellers_url, params: { seller: { dni: @seller.dni, email: @seller.email, gallery_name: @seller.gallery_name, name: @seller.name, phone: @seller.phone } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { dni: @seller.dni, email: @seller.email, gallery_name: @seller.gallery_name, name: @seller.name, phone: @seller.phone } }
